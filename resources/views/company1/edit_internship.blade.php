...
<div class="row">
<div class="col-lg-12">
	<form action="{{url('/employer/update_internship')}}" id="registrationForm" method="POST">
        @csrf
        ...
        <span id="additionalInfoError" class="error-message alert alert-warning">Please select the accommodation option</span>
           ...
           <!-- <span id="contactMobileError" class="error-message alert alert-warning ">Please Enter the Contact Mobile_Number</span>-->
			...
			<div class="form-group">
              ...
              <select class="form-control" id="contacttype" name="contacttype" onchange="toggleFields()">
                <option value="">Select the Contact Number Type</option>
                <option value="Mobile" {{ $int->contact_type === 'Mobile' ? 'selected' : '' }}>Mobile</option>
                <option value="Landline" {{ $int->contact_type === 'Landline' ? 'selected' : '' }}>Landline</option>
                <option value="Both" {{ $int->contact_type === 'Both' ? 'selected' : '' }}>Both</option>
                </select>
            ...
            <input class="form-control" type="number" id="contactMobile" value="{{$int->contact_number}}" name="contactMobile" placeholder="Enter the mobile number" onkeypress="return event.charCode === 0 || (/\d/.test(String.fromCharCode(event.charCode)) && this.value.length < 10)">
			...
			<div class="form-group">
              ...
              <input class="form-control" type="number" id="landline" name="landline" placeholder="Enter the landline number" onkeypress="return event.charCode === 0 || (/\d/.test(String.fromCharCode(event.charCode)) && this.value.length < 13)">
...
<div class="col-md-4">
			<div class="form-group">
                ...
                <textarea class="form-control" id="applicationProcedure" name="company_info" placeholder="Enter the application procedure" rows="15" maxlength="5000" oninput="validateApplicationProcedure(event)">{{$int->company_info}}</textarea>
                <span id="applicationProcedureError" class="error-message alert alert-warning" style="display: none;">Please Enter the Company Information</span>
            </div>
            </div>
			...
			<div class="col-md-4">
			<div class="form-group">
                <label for="selectionProcess">Internship Responsibilities</label>
                <textarea class="form-control" id="selectionProcess" name="responsibilities" placeholder="Enter the responsibilities" rows="15" maxlength="5000" oninput="validateSelectionProcess(event)">{{$int->responsibilities}}</textarea>
                <span id="selectionProcessError" class="error-message alert alert-warning" style="display: none;">Please Enter the Responsibilities</span>
            </div>
            </div>
...
//     hideErrorMessageOnFocus('contactEmail', 'contactEmailError');
//   }
// //   else if (contactEmail.length < 4 ||contactEmail.length > 30) {
// //   document.getElementById('contactEmailError').textContent = 'Email length should be between 4 and 30 characters before "@" symbol.';
// //   document.getElementById('contactEmailError').style.display = 'block';
// //   isValid = false;
// //   hideErrorMessageOnFocus('contactEmail', 'contactEmailError');
// //   }
...
// var landlinePattern = /^0\d{2,5}\d{6,8}$/;
// var landlineField = document.getElementById('landline');
// var landlineError = document.getElementById('landlineError');
...
//     landlineError.textContent = 'Invalid landline number. Please enter a valid Indian landline number.';
//     landlineError.style.display = 'block';
//     isValid = false;
//     hideErrorMessageOnFocus('landline', 'landlineError');
//   } else {
