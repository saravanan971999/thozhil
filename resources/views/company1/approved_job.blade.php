	...
	<div class="main-wrapper">
		...
		<div class="page-wrapper">
			<div class="content container-fluid">
				<h5 class="mt-5">Approved Job Application</h5>
				<div class="page-header">
                    ...
                    <script>
                        function NotQualified() {
                            var baseUrl = '{{ url("employer/approved_job/not_qualified") }}'; // Replace with your actual sort endpoint
                        ...
                        function sortResults() {
                            ...
                            var baseUrl = '{{ url("employer/approved_job/qualified") }}'; // Replace with your actual sort endpoint
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        searchBtn.addEventListener('click', function () {
            ...
            if (!query) {
                ...
                fetch('/approved_job_application_search/' + query)
...
<script>
 ...
    });
                                    ...
                                    <input type="hidden" name="intern" value="11" id="">
