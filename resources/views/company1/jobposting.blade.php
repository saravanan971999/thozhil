...
<body>
        <div class="form-control">
            ...
            <div class="title">
                ...
                <center><h3>1000+ companies hiring on <Span>Thozhil</Span></h3></center>
                </div>
                <br>
    ...
    <option value="others">Others</option>
      ...
      <span id="job_typeError" class="error-message  alert alert-warning">Please select your job type</span>
      </div>
        ...
        <div class="input-box">
            ...
            <span id="job_titleError" class="error-message  alert alert-warning ">Please enter the internship title</span>
        </div>
        ...
        <div class="input-box">
            ...
            <textarea id="jobDescription" name="jobDescription" placeholder="Enter the Job Description" rows="2" maxlength="250" onkeypress="return event.target.value.length < 250"></textarea>
            <span id="jobDescriptionError" class="error-message alert alert-warning ">Please provide the Job Description</span>
        </div>

            <div class="input-box">
            <label for="skills">Required Skills:</label>
            <textarea id="skills" name="skills" placeholder="Enter the Required Skills" rows="2" maxlength="150" onkeypress="return event.target.value.length < 150"></textarea>
    ...
    <span id="salaryError" class="error-message alert alert-warning">Please select the stipend range</span>
</div>
  ...
  document.getElementById('degrees').addEventListener('change', function() {
    ...
    if (this.value === 'Others') {
        ...
        otherDegreeInput.style.display = 'none';
            ...
            <div class="input-box">
            <label for="selectionProcess">Selection Process:</label>
            <textarea id="selectionProcess" name="selectionProcess" placeholder="Enter the Selection Process" rows="3" maxlength="250" onkeypress="return event.target.value.length < 250"></textarea>
            <span id="selectionProcessError" class="error-message alert alert-warning ">Please Enter the Selection Process details</span>
        </div>


            <div class="input-box">
            <label for="applicationProcedure">Application Procedure:</label>
            <textarea id="applicationProcedure" name="applicationProcedure" placeholder="Enter the application Procedure" rows="3" maxlength="250" onkeypress="return event.target.value.length < 250"></textarea>
            <span id="applicationProcedureError" class="error-message alert alert-warning ">Please Enter the Application Procedure details</span>
        </div>

        <div class="input-box">
            <label for="workLocation">Work Location:</label>
            <input type="text" id="workLocation" name="workLocation" placeholder="Enter the Work Location" maxlength="100" onkeypress="return event.target.value.length < 100">
            <span id="workLocationError" class="error-message alert alert-warning ">Please Enter the Selection Process details</span>
        </div>
