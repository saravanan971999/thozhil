...
<head>
	...
	<title>Offer Oasis Internships</title>
...
<body>
    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            <h5 class="mt-5">Offer Oasis Internships</h5>
                                    ...
                                    document.addEventListener('DOMContentLoaded', function () {
                                        ...
                                        searchBtn.addEventListener('click', function () {
                                            ...
                                            if (query === '') {
                                                ...
                                                fetch('/results_intern_application_search/' + query)
...
<script>
    function filterResults(value) {
        var baseUrl = '{{ url("employer/results_intern") }}'; // Replace with your actual URL endpoint
