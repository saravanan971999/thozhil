        ...
        sortedData +=  `</td>
                        ...
                        <div class="dropdown dropdown-action">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="{{ url('/employer/edit_internship/'.`+applications[i].job_id+`) }}">
                        ...
                        <div class="modal-content">
                            <div class="modal-body text-center">
                                ...
                                <div class="m-t-20">
                                    ...
                                    <a href="{{ url('/employer/delete_internship/'.`+applications[i].job_id+`) }}" class="btn btn-danger">Delete</a>
                                </div>
                            </div>
                        </div>
                    </div>
						...
						<div class="card card-table">
							...
							<div class="card-body booking_card">
								<div class="table-responsive">
                                    <form action="{{url('employer/delete_selected_job')}}" method="post">
                                        @csrf
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <div class="dropdown dropdown-action">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a class="dropdown-item" href="{{ url('/employer/edit_job/'.$int->job_id) }}">
                                                                <i class="fas fa-pencil-alt m-r-5"></i> Edit
                                                            </a>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-body text-center">
                                                            ...
                                                            <div class="m-t-20">
                                                                <a href="#" class="btn btn-white" data-dismiss="modal">Close</a>
                                                                <a href="{{ url('/employer/delete_job/'.$int->job_id) }}" class="btn btn-danger">Delete</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
