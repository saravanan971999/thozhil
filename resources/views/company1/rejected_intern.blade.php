...
<body>
	<div class="main-wrapper">
		...
		<div class="page-wrapper">
			<div class="content container-fluid">
				<h5 class="mt-5">Rejected Internship Application</h5>
    ...
    <div class="input-group-append">
        <button style="margin-left:-38px;" class="btn btn-outline-success" id="Search_btn">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        searchBtn.addEventListener('click', function () {
            ...
            if (!query) {
                ...
                fetch('/rejected_intern_application_search/' + query)
        ...
        document.removeEventListener('click', clickOutsidePopup);
                ...
                {{-- <td class="text-right">
                    <div class="btn-group">
                        ...
                        <a href="{{ url('/employer/reject_intern', ['input' => $int->application_id]) }}">
