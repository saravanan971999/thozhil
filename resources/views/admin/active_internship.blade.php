                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Internship Title</th>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Duration(in month)</th>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Stipend(in month)</th>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Start Date</th>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Application Deadline</th>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Total Vacancies</th>
                    </tr>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center">{{$u->company_name}}</td>
                      <td class="text-center">{{$u->internship_title}}</td>
                      <td class="text-center">{{$u->duration}}</td>
                      @if ($u->stipend == "others")
                      <td class="text-center">{{$u->stipend_others}}</td>
                      @else
                      <td class="text-center">{{$u->stipend}}</td>
                      @endif

                      <td class="text-center">{{$u->application_start_date}}</td>
                      <td class="text-center">{{$u->application_deadline}}</td>
                      <td class="text-center">{{$u->contact_email}}</td>
                      <td class="text-center">{{$u->contact_number}}</td>
                      <td class="text-center">{{$u->total_vacancies}}</td>
                    </tr>
                    @endforeach
