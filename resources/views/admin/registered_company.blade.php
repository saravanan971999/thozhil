...
<div class="container-fluid py-4">
      <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6>Registered company tables</h6>
            </div>
        ...
        <tr>
          ...
          <td>
            <p class="text-xs font-weight-bold mb-0 text-center">{{$c->company_name}}</p>
          </td>
          <td>
            <p class="text-xs font-weight-bold mb-0 text-center">{{$c->company_type}}</p>
          </td>
          <td>
            <p class="text-xs font-weight-bold mb-0 text-center">{{$c->registration_no}}</p>
          </td>
          <td class="align-middle text-center text-center">
            <span class="text-secondary text-xs font-weight-bold">{{$c->year_of_founding}}</span>
          </td>
          <td>
            <p class="text-xs font-weight-bold mb-0 text-center">{{$c->email}}</p>
          </td>
          <td>
            <p class="text-xs font-weight-bold mb-0 text-center">{{$c->phone}}</p>
          </td>
          <td>
            <p class="text-xs font-weight-bold mb-0 text-center">{{$c->district}}</p>
          </td>
          <td>
            <p class="text-xs font-weight-bold mb-0 text-center">{{$c->state}}</p>
          </td>
          <td>
            <p class="text-xs font-weight-bold mb-0 text-center">{{$c->pincode}}</p>
          </td>
        </tr>
        @endforeach
