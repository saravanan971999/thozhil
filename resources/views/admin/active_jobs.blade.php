                  ...
                  <table class="table align-items-center mb-0">
                    <thead>
                      <tr>
                        ...
                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Salary Package</th>
                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Experience Required(in years)</th>
                    ...
                    <tr>
                      ...
                      <td class="text-center">{{$u->job_title}}</td>
                      <td class="text-center">{{$u->total_vacancies}}</td>
                      <td class="text-center">{{$u->start_date}}</td>
                      <td class="text-center">{{$u->application_deadline}}</td>

                      @if ($u->salary_package == "others")
                      <td class="text-center">{{$u->other_salary}}</td>
                      @else
                      <td class="text-center">{{$u->salary_package}}</td>
                      @endif

                      <td class="text-center">{{$u->experience_required}}</td>
                      <td class="text-center">{{$u->contact_email}}</td>
                      <td class="text-center">{{$u->contact_mobile}}</td>
                    </tr>
                    @endforeach
