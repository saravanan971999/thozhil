...
<tr>
    ...
    <td>
        <p class="text-xs font-weight-bold mb-0 text-center">{{$int->company_name}}</p>
    </td>
    <td>
        <p class="text-xs font-weight-bold mb-0 text-center">{{$int->company_type}}</p>
    </td>
    <td>
        <p class="text-xs font-weight-bold mb-0 text-center">{{$int->registration_no}}</p>
    </td>
    <td class="align-middle text-center text-center">
        <span class="text-secondary text-xs font-weight-bold">{{$int->year_of_founding}}</span>
    </td>
    <td>
        <p class="text-xs font-weight-bold mb-0 text-center">{{$int->email}}</p>
    </td>
    <td>
        <p class="text-xs font-weight-bold mb-0 text-center">{{$int->phone}}</p>
    </td>
    <td>
        <p class="text-xs font-weight-bold mb-0 text-center">{{$int->district}}</p>
    </td>
    <td>
        <p class="text-xs font-weight-bold mb-0 text-center">{{$int->state}}</p>
    </td>
    <td>
        <p class="text-xs font-weight-bold mb-0 text-center">{{$int->country}}</p>
    </td>

    <td>
        <p class="text-xs font-weight-bold mb-0 text-center">{{$int->pincode}}</p>
    </td>
    <td>
        <div class="d-flex justify-content-center">
           <a href="{{url('/approval_company/'.$int->employer_id)}}"> <button class="btn btn-success btn-sm me-2">Approve</button></a>
           <a href="{{url('/reject_company/'.$int->employer_id)}}"> <button class="btn btn-danger btn-sm">Decline</button></a>
        </div>
    </td>
