        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6>Candidate internship application</h6>
            </div>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Internship Title</th>
...
<td>
    <button class="btn btn-danger btn-sm" id="resumeID" value="{{urlencode($c->resume)}}" onclick="view(this.value)" ><i class="fas fa-eye"></i></button>

</td>
<td class="text-center">{{$c->company_name}}</td>
    <td class="text-center">{{$c->internship_title}}</td>
