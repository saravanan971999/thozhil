        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6>Candidates job application</h6>
            </div>
...
<td>
    <button class="btn btn-danger btn-sm" id="resumeID" value="{{urlencode($c->resume)}}" onclick="view(this.value)" >View</button>
