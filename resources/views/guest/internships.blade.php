          ...
          <div class="row">
            <div class="col-lg-6 align-self-center">
              <div class="left-content show-up header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                <div class="row">
                  <div  class="col-lg-9">
                    <h2 style="font-size:37px;" class="animate">“Always remember, your focus determines your reality.”</h2>
                </div>
                  <div class="col-lg-12">
...
<section id="particular_div">
    <style>
        ...
        .card-container {
            grid-template-columns: repeat(1, 1fr); /* Set the column count to 1 on smaller screens */
        }
	...
	/* color: #2e78fd;  */
	font-size: 45px;
	background: linear-gradient(to left,#322d31 50%, rgb(255, 255, 0));
...
<div class="container">
    <div class="row d-flex justify-content-center">
        <div class="col-md-3 d-flex justify-content-center" style="margin-top: 80px;height:690px;">
            <div class="filter-container" style="margin-left: 10px;">
                    <form id="filterForm" action="{{ route('internship_search') }}" method="get">
                        @csrf
            ...
            @endif
                        <br>
                        <label for="profile">Internship Role</label>
                        <input type="text" placeholder="(e.g., Marketing Intern)" name="title" id="title" onkeypress="return /[a-zA-Z\s]/i.test(event.key) && this.value.length < 30">
...
" onkeypress="return enforceMaxLength(event, 30);">
                        ...
                        <input type="text" name="location" placeholder="(e.g., Bangalore)" id="location" onkeypress="return /[a-zA-Z\s]/i.test(event.key) && this.value.length < 30">
                        ...
                        <select id="stipend" name="stipend">
                            ...
                            <option value="6000-7000">6k - 7k</option>
                            <option value="7000-8000">7k - 8k</option>
                            <option value="8000-9000">8k - 9k</option>
                            <option value="9000-10000">9k - 10k</option>
                            <option value="More than 10k">More than 10k</option>
                        </select>
                        <span id="stipendError"  class="error-message" style="display: none; color: red; font-size: 0.8em; margin-top: 5px;"></span>
                        ...
                        <span id="durationError"  class="error-message " style="display: none; color: red; font-size: 0.8em; margin-top: 5px;"></span>


                        

                        <br><br>
                       <center><button type="button" id="submitForm">Submit</button></center> 
                    </form>
...
function filterFormValidation() {
    ...
    if (title === '' && location === '' && skills === '' && stipend === '' && duration === '') {
        ...
        return true; // Return true to allow form submission
              ...
              if(userId){
                            ...
                            if(filterFormValidation()){
                                ...
                                // Construct the URL with the route for internship filter
                                var url = '{{ secure_url("internship_filter") }}';
            ...
            <div class="col-md-8 mt-4">
                <center><h1 class="h2Class">INTERNSHIP'S</h1></center>
                ...
                <div class="search ">
                    ...
                    @if (request()->has('part_time'))
                        ...
                        @elseif (request()->has('full_time'))
                            <input type="hidden" name="ptft" value="2">
            @endif
                    <button type="submit" id="search_input" style="border-radius:30px;padding:5px;" class="btn btn-primary">Search</button>
                </div>
            </form>
...
<script>
        ...
        if (userId) {
            if(searchFormvalidation()){
                ...
                // Construct the URL with the route for internship search
                var url = '{{ secure_url("internship_search") }}';
