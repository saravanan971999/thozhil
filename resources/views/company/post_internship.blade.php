...
<body>
    ...
    <div class="main-wrapper">
        ...
        <div class="">
            ...
            <div class="title">
                ...
                <center><h3>1000+ Companies Hiring On <Span> <img class="logo_img" style="width:120px;"  src="{{asset('Thozhil/thozhill-removebg-preview (1).png')}}"</Span> </h3></center>
              </div>
                <br>

            <div class="container">

                <form action="{{url('internship_post_form')}}" novalidate method="POST" id="registrationForm">
                    <div class="user-details">
                        @csrf

                        <div class="input-box">
                            <label for="company_name">Company Name</label>
                            <input type="text" value="{{$emp->company_name}}" placeholder="Enter company name" name="company_name" id="company_name" maxlength="50" onblur="validateField(this)" onkeydown="return validateCompanyName(event)" readonly>
    ...
    <div class="input-box">
      <label for="ptft">Internship Nature <span style="color: red;">*</span></label>
...
{{--
            ...
            <script>
                ...
                <div class="input-box">
                  ...
                  <input type="text" id="contactEmail" name="contactEmail" value="{{$emp->email}}" placeholder="Enter the email id" onblur="validateField(this)" onkeyup="this.value=this.value.replace(/[^a-z0-9@._-]/g,'')" readonly>
            ...
            <input type="text" id="contactMobile" value="{{$emp->phone}}" name="contactMobile" placeholder="Enter the contact number">
           <!-- <span id="contactMobileError" class="error-message  ">Please Enter the Contact Mobile_Number</span>-->
                ...
                <div class="input-box">
                    ...
                    <textarea id="applicationProcedure" name="company_info" placeholder="Enter the company information" rows="15" maxlength="5000" onblur="validateField(this)" oninput="validateApplicationProcedure(event)">{{$emp->description}}</textarea>
                ...
                <div class="input-box">
                    ...
                    <span id="selectionProcessError" class="error-message " style="display: none;">Please enter the responsibilities details</span>
                </div>
            ...
            <div class="input-box">
                ...
                <span id="countryError" class="error-message ">Please select this field</span>
                </div>
                ...
                <span id="stateError" class="error-message ">Please select this field</span>
            </div>
