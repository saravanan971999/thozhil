    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl py-5 bg-dark page-header mb-5">
            <div class="container my-5 pt-5 pb-4">
                <h1 class="display-3 text-white mb-3 animated slideInDown">Internship List</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb text-uppercase">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item"><a href="#">Pages</a></li>
                        <li class="breadcrumb-item text-white active" aria-current="page">Internship List</li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card style_card">
                            ...
                            <div class="card-body mt-5">
                                <h5 class="card-title">{{$in->internship_title}}</h5>
                                <p class="card-text">{{$in->company_name}}</p>
                                <div>
                                    <!-- <a href="#" class="btn btn-apply-now">Apply Now</a> -->
                                    <a href="{{url('/candidate/internship_detail',["id"=> $in->internship_id])}}" class="btn btn-view-more">View More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="justify-content-center align-items-center">
                        <div class="col-md-12 mb-4 text-left"> <!-- Updated to text-left class -->
                            <h1 class="heading text-white">
                                Thozhil<br> <span style="color: rgb(21, 22, 22)"> </span>
                            </h1>
                        </div>
