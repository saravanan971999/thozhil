<div class="container mt-3">
    <div class="row align-items-center">
        <div class="col-md-4">
            <h5>Approved Internship Applications:
                @if ($total_int != 0)
                    {{$total_int}}
                @else
                    No records
            ...
            @foreach ($app_int as $int)
                <div class="col-md-4">
                    <div class="card job-card">
                        ...
                        @endphp
                            <a href="{{url('internship_detail/'.$encryptedId)}}"><button class="btn btn-primary view-more-btn">View More</button></a>
                        </div>
                    </div>
                </div>
            @endforeach
