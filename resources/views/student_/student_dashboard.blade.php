    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                <a href="stu_dashboard.html" class="nav-item nav-link ">Jobs</a>
                <a href="internship.html" class="nav-item nav-link">Internship</a>
            </div>
                <!-- Add the profile dropdown -->
                <div class="nav-item dropdown">
                    <a class="" href="index.html" id="" role="button" data-toggle="" aria-haspopup="" aria-expanded="">
...
<br><br>
        ...
        <div class="container-fluid p-0">
            <div class="owl-carousel header-carousel position-relative">
                <div class="owl-carousel-item position-relative">
                    <img class="img-fluid" src="index.webp" alt="">
                    <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(120, 163, 158, 0.374);">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-10 col-lg-8">
                                    <h1 class="display-3 text-white animated slideInDown mb-4">Unlock Your Potential: Find Your Dream Job and Internships Here!</h1>
                                    <p class="fs-5 fw-medium text-white mb-4 pb-2">Providing Internship Opportunities Changes the whole equation. <br> Join OneYes Internships Program in Technologies with our Internship Offer.</p>
                                    <!-- <a href="all_jobs.html" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Search A Job</a> -->
                ...
                <div class="owl-carousel-item position-relative">
                    <img class="img-fluid" src="index2.jpg" alt="">
                    <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(120, 163, 158, 0.374);">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-10 col-lg-8">
                                    <h1 class="display-3 text-white animated slideInDown mb-4">"Shape Your Future: Explore Exciting Job and Internship Opportunities"</h1>
                                    <p class="fs-5 fw-medium text-white mb-4 pb-2">Providing Internship Opportunities Changes the whole equation. <br> Join OneYes Internships Program in Technologies with our Internship Offer.</p>
        ...
        <!-- Search Start -->
        <div class="container-fluid  mb-5 wow fadeIn" data-wow-delay="0.1s" style="padding: 35px; background-color: #4b8ef1">
            <div class="container">
                <div class="row g-2">
                    <div class="col-md-10">
                        <div class="row g-2">
                            ...
                            <div class="col-md-4">
                                <select class="form-select border-0">
                                    <option selected>Stipend</option>
                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                        <div class="row g-0 about-bg rounded overflow-hidden">
                            <div class="col-6 text-start">
                                <img class="img-fluid w-100" src="index.webp">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid" src="index2.jpg" style="width: 85%; margin-top: 15%;">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid" src="./img/b4.jpg" style="width: 85%;">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid w-100" src="./img/back2.webp">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                        <h1 class="mb-4">We Help To Get The Best Job And Internship Find A Talent</h1>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Latest Post</h1>
                <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.3s">
                    <div class="tab-content">
                        <div id="tab-1" class="tab-pane fade show p-0 active">
                            ...
                            <a class="btn btn-primary py-3 px-5" href="all_jobs.html">Browse More</a>
                        </div>
                        <div id="tab-2" class="tab-pane fade show p-0">
                            ...
                            <a class="btn btn-primary py-3 px-5" href="all_jobs.html">Browse More Jobs</a>
                        </div>
                    ...
                    <div class="justify-content-center align-items-center">
                        <div class="col-md-12 mb-4 text-left"> <!-- Updated to text-left class -->
                            <h1 class="heading text-white">
                                OneYes<br> <span style="color: rgb(26, 28, 28)"> Internship</span>
                            </h1>
                        </div>
