    ...
    <div class="align-items-center">
        <div class="col-md-6">
            <div class="col-md text-center mb-2 d-flex">
                ...
                <div class="input-group col-md-4" id="SEARCH_OPTION" style="display: none">
                ...
                <div class="input-group col-md-4" id="SEARCH_OPTION_JOB" style="display: none">
                    @if ($total_int >6 || $total_job > 6)
                    <span class="input-group-text">
...
<script>
    ...
    document.getElementById('jobID').style.display = "";
        ...
        filterForm.addEventListener('click', function (e) {
            ...
            fetch("{{ route('search_total_applied_internships') }}?title=" + queryString)
                .then(response => response.text())
                .then(data => {
    ...
    var filterForm = document.getElementById('search_btn_job');
        ...
        filterForm.addEventListener('click', function (e) {
            ...
            fetch("{{ route('search_total_applied_jobs') }}?title=" + queryString)
                .then(response => response.text())
                .then(data => {
                    loading.classList.add('d-none');
                    document.getElementById('jobs-container').innerHTML = "";
...
function viewInt(){
    let loading = document.getElementById('loading');
            loading.classList.remove('d-none');
    fetch('/view_total_applied_internships')
                .then(response => {
                    if (!response.ok) {
                        throw new Error('Network response was not ok');
                    }
    ...
    document.getElementById('internship').style.display = "";
    document.getElementById('viewBTTN').style.display = "none";
    document.getElementById('viewBTTNjob').style.display = "";
...
let loading = document.getElementById('loading');
    ...
    document.getElementById('internship').style.display = "none";
    document.getElementById('jobID').style.display = "";
    document.getElementById('viewBTTN').style.display = "";
    document.getElementById('viewBTTNjob').style.display = "none";
