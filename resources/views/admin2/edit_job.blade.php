...
<div class="row">
    <div class="col-lg-12">
	<form action="{{url('/admin2/update_job')}}" id="registrationForm" method="POST" enctype="multipart/form-data">
        @csrf
...
<!-- <input class="form-control" value="{{$int->job_type}}" name="job_type" type="text" id="internshipTitle"> -->
          ...
          <div class="col-md-4">
			<div class="form-group">
			  ...
			  <input type="text" placeholder="Enter the job title" name="job_title" id="job_title" class="form-control" value="{{$int->job_title}}" onkeypress="return /[a-zA-Z]/i.test(event.key) && this.value.length < 50">
...
<div class="col-md-4">
    <div class="form-group">
        ...
        <select id="salary" class="form-control" name="salary" onchange="showOtherField()">
            ...
            <option value="Pay to be determined later" {{ $int->salary_package === 'Pay to be determined later' ? 'selected' : '' }}>Pay to be determined later</option>
            <option value="Earnings discussed during interview" {{ $int->salary_package === 'Earnings discussed during interview' ? 'selected' : '' }}>Earnings discussed during interview</option>
            <option value="1-2 LPA" {{ $int->salary_package === '1-2 LPA' ? 'selected' : '' }}>1-2LPA</option>
            <option value="2-3 LPA" {{ $int->salary_package === '2-3 LPA' ? 'selected' : '' }}>2-3LPA</option>
            <option value="3-4 LPA" {{ $int->salary_package === '3-4 LPA' ? 'selected' : '' }}>3-4LPA</option>
            <option value="4-5 LPA" {{ $int->salary_package === '4-5 LPA' ? 'selected' : '' }}>4-5LPA</option>
            <option value="5-6 LPA" {{ $int->salary_package === '5-6 LPA' ? 'selected' : '' }}>5-6LPA</option>
            <option value="6-7 LPA" {{ $int->salary_package === '6-7 LPA' ? 'selected' : '' }}>6-7LPA</option>
            <option value="7-8 LPA" {{ $int->salary_package === '7-8 LPA' ? 'selected' : '' }}>7-8LPA</option>
            <option value="8-9 LPA" {{ $int->salary_package === '8-9 LPA' ? 'selected' : '' }}>8-9LPA</option>
            <option value="9-10 LPA" {{ $int->salary_package === '9-10 LPA' ? 'selected' : '' }}>9-10LPA</option>
            <option value="More than 10 LPA" {{ $int->salary_package === 'More than 10 LPA' ? 'selected' : '' }}>More than 10LPA</option>
    ...
    if (this.value === 'others') {
        ...
        otherDegreeInput.style.display = 'none';
		  ...
		  <div class="col-md-4">
            ...
            <option value="Fresher & Experienced" {{ $int->experience_required === 'Fresher & Experienced' ? 'selected' : '' }}>Fresher & Experienced</option>
            <option value="0-1 years"{{ $int->experience_required === '0-1 years' ? 'selected' : '' }}>0-1yrs</option>
            <option value="1-2 years"{{ $int->experience_required === '1-2 years' ? 'selected' : '' }}>1-2yrs</option>
            <option value="2-3 years"{{ $int->experience_required === '2-3 years' ? 'selected' : '' }}>2-3yrs</option>
            <option value="3-4 years"{{ $int->experience_required === '3-4 years' ? 'selected' : '' }}>3-4yrs</option>
            <option value="4-5 years"{{ $int->experience_required === '4-5 years' ? 'selected' : '' }}>4-5yrs</option>
            <option value="5-6 years"{{ $int->experience_required === '5-6 years' ? 'selected' : '' }}>5-6yrs</option>
            <option value="6-7 years"{{ $int->experience_required === '6-7 years' ? 'selected' : '' }}>6-7yrs</option>
            <option value="7-8 years"{{ $int->experience_required === '7-8 years' ? 'selected' : '' }}>7-8yrs</option>
            <option value="8-9 years"{{ $int->experience_required === '8-9 years' ? 'selected' : '' }}>8-9yrs</option>
            <option value="9-10 years"{{ $int->experience_required === '9-10 years' ? 'selected' : '' }}>9-10yrs</option>
            <option value="More than 10 years"{{ $int->experience_required === 'More than 10 years' ? 'selected' : '' }}>More than 10yrs</option>
            </select>
		  ...
		  {{-- <div class="col-md-4">
            ...
            <span id="workLocationError" class="error-message alert alert-warning ">Please Enter the preferred work location</span>
			  <!-- <input class="form-control" value="{{$int->work_location}}" name="work_location" type="text" id="totalVacancies"> -->
			</div>
		  </div> --}}
           <div class="col-md-4">
			<div class="form-group">
    ...
    <div class="form-group">
		...
		<div class="col-md-4">
		  <div class="form-group">
            ...
            <input type="text" placeholder="Enter your country" name="country" id="country" class="form-control" value="{{$int->country}}" maxlength="50">
		 ...
		 <div class="col-md-4">
            ...
            <input type="text" placeholder="Enter your state" name="state" id="state" class="form-control" value="{{$int->state}}" maxlength="50">
		...
		<div class="col-md-4">
		  <div class="form-group">
            <label for="district">District</label>
             <input type="text" placeholder="Select preferred work location" name="district" id="district" class="form-control" value="{{$int->city}}" maxlength="50">
        ...
        <div class="input-box">
            ...
            <input type="file" name="photo" id="photo" accept=".jpg, .jpeg">
