    ...
    <div class="main-wrapper">
        ...
        <div class="">
            ...
            <div class="title">
               ...
               <center><h3>1000+ companies hiring on <Span> <img style="width:120px; margin-bottom:10px;"  src="{{asset('Thozhil/thozhill-removebg-preview (1).png')}}"</Span></h3></center>
                </div>
                <br>

            <div class="container">
                <form action="{{url('job_posting_form')}}" id="registrationForm" method="POST" enctype="multipart/form-data">
                    @csrf
...
if (this.value === 'others') {
  ...
  otherDegreeInput.style.display = 'none';
        ...
        <div class="input-box">
            ...
            <input type="text" placeholder="Enter the job role" name="job_title" id="job_title" onkeypress="return /[a-zA-Z\s]/i.test(event.key) && this.value.length < 50">
    ...
    // renderChoiceLimit: 5
           ...
           <!-- <span id="contactMobileError" class="error-message ">Please Enter the Contact Mobile_Number</span>-->
            ...
            <div class="input-box">
                ...
                <textarea id="applicationProcedure" name="company_info" placeholder="Enter the company details" rows="15" maxlength="10000" onkeypress="return event.target.value.length < 10000"></textarea>
...
} else if (jobDescription.length < 10) { // Adding minimum length limit (30 characters)
  document.getElementById('jobDescriptionError').innerText = 'Job Description should contain atleast 10 characters.';
  document.getElementById('jobDescriptionError').style.display = 'block';
  isValid = false;
  hideErrorMessageOnFocus('jobDescription', 'jobDescriptionError');
...
if (startDate === '') {
    ...
    document.getElementById('applicationDeadlineError').innerText = 'Please enter the application end date';
